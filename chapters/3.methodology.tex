...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\columnwidth]{images/t-sne-p50-scatter-is_injured.png}
    \caption[2D t-SNE plot with perplexity 50]{2D t-SNE plot with perplexity 50. Injured samples appear in blue and uninjured in orange.\label{fig:met-tsne-injured}}
\end{figure}

Figure \reg{fig:met-tsne-injured} visualizes two t-sne dimensions

This provided an intuitive visualisation of the structure of the dataset and helps to assess whether meaningful separation is possible before training predictive models.
