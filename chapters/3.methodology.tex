...
\begin{table}[htbp]
    ...
    \begin{tabular}{lll}
        ...
        \hline
        \multicolumn{3}{l}{\textit{Top 2 by Chi$^2$ p-value}} \\
        & gender & 0.193481 \\
        & id & 0.488958 \\
        \hline
    \end{tabular}
...
Seeing the effect of removing collinearity, we decide to keep only the dominant pair from left and right. And to not loose information of the non-dominant side completely, extract the difference between both sides as a varible. The VIF is now reduced significatly, going from only 10 variables below VIF = 10 to 32 and those variables over 10 have a value significatly less than before the change.
