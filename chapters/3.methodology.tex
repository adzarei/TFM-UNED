...
Given the difference in structure of both groups of datasets we need to apply different techniques and methods when working with the. Below we will discuss each of them separately.
