...
\verb|\cite{aikg}|, que se se visualizaría como \cite{Bartlett2014}. 

Cuando queramos citar más de un trabajo en un mismo punto del documento se deberán añadir a la cita separados por comas, por ejemplo: \verb|\cite{chen_2018, Qin_2020}|, que se visualizaría como \cite{Bartlett2014, Dibbern2025}. En estos casos es habitual añadir las citas en orden cronológico de más antigua a más reciente.
...
``Algunos ejemplos de grafos de conocimiento se presentan en \citet{Bartlett2014}'' 
...
``Existe una gran variedad de aplicaciones de los grafos de conocimiento \citep{Bartlett2014}.''
